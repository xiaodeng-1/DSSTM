...
class SeqDistanceSelfAttention(Layer):
    ...
    def __init__(self,
                 ...
                 attention_direction = "3-gram",
                 attention_distance="abs",
    ...
    def call(self, inputs, mask=None, **kwargs):
        ...
        elif self.attention_direction == 'diag':
        ...
        # distance mask
        if self.attention_distance == 'abs':
            distance_mask = -tf.abs(sl_col-sl_row)
        elif self.attention_distance == 'log':
            temp_mask = K.cast(tf.abs(sl_col - sl_row), K.floatx())+0.0001
            distance_mask = -tf.log(temp_mask)
        ...
        distance_mask1 = distance_mask.eval()
        distance_mask = tf.convert_to_tensor(distance_mask1)
        temp_e = e
        e +=distance_mask

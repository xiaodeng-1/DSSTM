...
class MultiMatch(Layer):
    ...
    def __init__(self, mp_dim, epsilon=1e-6, **kwargs):
        ...
        self.epsilon = 1e-6
        self.strategy = 4
        super(MultiMatch, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        self.kernel_full_fw = self.add_weight(shape=(self.mp_dim,100),
                                            name='kernel_full_fw',
                                            regularizer=l2(0.000001),
                                            initializer='glorot_uniform',
                                            trainable=True)
        self.kernel_full_bw = self.add_weight(shape=(self.mp_dim, 100),
                                              name='kernel_full_bw',
                                              regularizer=l2(0.000001),
                                              initializer='glorot_uniform',
                                              trainable=True)
        self.kernel_attentive_fw = self.add_weight(shape=(self.mp_dim, 100),
                                              name='kernel_attentive_fw',
                                              regularizer=l2(0.000001),
                                              initializer='glorot_uniform',
                                              trainable=True)
        self.kernel_attentive_bw = self.add_weight(shape=(self.mp_dim, 100),
                                              name='kernel_attentive_bw',
                                              regularizer=l2(0.000001),
                                              initializer='glorot_uniform',
                                              trainable=True)
        self.kernel_max_attentive_fw = self.add_weight(shape=(self.mp_dim, 100),
                                              name='kernel_max_attentive_fw',
                                              regularizer=l2(0.000001),
                                              initializer='glorot_uniform',
                                              trainable=True)
        self.kernel_max_attentive_bw = self.add_weight(shape=(self.mp_dim, 100),
                                                   name='kernel_max_attentive_bw',
                                                   regularizer=l2(0.000001),
                                                   initializer='glorot_uniform',
                                                   trainable=True)
        self.kernel_max_pool_fw = self.add_weight(shape=(self.mp_dim, 100),
                                                       name='kernel_max_pool_fw',
                                                       regularizer=l2(0.000001),
                                                       initializer='glorot_uniform',
                                                       trainable=True)
        self.kernel_max_attentive_bw = self.add_weight(shape=(self.mp_dim, 100),
        ...
        # self.built = True
        super(MultiMatch, self).build(input_shape)
    ...
    def get_config(self):
        ...
        base_config = super(MultiMatch, self).get_config()
